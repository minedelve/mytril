...
export const alignSelf = ['stretch', 'flex-start', 'flex-end', 'center', 'baseline', 'auto'];
...
export const overflow = ['auto', 'hidden', 'visible'];
export const position = ['static', 'relative', 'absolute', 'fixed', 'sticky'];
export const height = ['auto', '100dvh', '0', '25%', '50%', '75%', '100%'];
export const width = ['auto', '0', '25%', '50%', '75%', '100%'];
...
export const textAlign = ['start', 'end', 'center', 'justify', 'left', 'right'];
export const textTransform = ['uppercase', 'lowercase', 'capitalize'];
