...
export const componentsCSS = [
	...
	path.resolve(`${directory}/components/grids/grid`, 'grid.css'),
	path.resolve(`${directory}/components/grids/grid-col`, 'grid-col.css'),
	path.resolve(`${directory}/components/grids/grid-row`, 'grid-row.css'),
