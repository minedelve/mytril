...
- New ui for Toolbar component and new HTML structure for simplify integration.
- New HTML structure for ToolbarTitle.
- New ui and new logic for AppBar, Diff structre with toolbar.
- New HTML structure for AppBarTitle.
- Delete ToolbarItems component because not interest for ui.

### Fixed

- App components render children crash if not correctly load with Svelte
- Optimize Typescript intégration
